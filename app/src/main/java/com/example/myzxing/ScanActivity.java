...
public class ScanActivity extends BaseCaptureActivity implements SurfaceHolder.Callback {
    ...
    public static final int REQUEST_CODE = 0x70;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        NavBarHeader titleBar = (NavBarHeader) findViewById(R.id.nav_bar_header);
    ...
    private void initCamera(SurfaceHolder surfaceHolder) {
        try {
            ...
            Toast.makeText(this,"打开相机失败，请检查是否允许程序使用相机权限",Toast.LENGTH_SHORT).show();
            finish();
        }
        if (handler == null) {
